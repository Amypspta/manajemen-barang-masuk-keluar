    ...
    <x-sidebar sticky stashable class="border-r border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
        ...
        <x-navlist>
            <x-navlist.group :heading="__('Platform')">
                ...
                <x-navlist.item before="phosphor-database" :href="route('transactions.index')" :current="request()->routeIs('transactions.index')">
    {{ __('Manajemen Barang') }}
</x-navlist.item>
                ...
                @role(['petugas', 'admin'])
                <x-navlist.item before="phosphor-house-line" :href="route('transactions.index')"
                ...
                @role('admin')
                <x-navlist.item before="phosphor-house-line" :href="route('product-categories.index')"
                    :current="request()->routeIs('product-categories.index')">
                    {{ __('Product Categories') }}
                </x-navlist.item>
                <x-navlist.item before="phosphor-barcode" :href="route('products.index')"
                    :current="request()->routeIs('products.index')">
                    {{ __('Products') }}
                </x-navlist.item>

                <x-navlist.item before="phosphor-user" :href="route('users.index')"
                    :current="request()->routeIs('users.index')">
                    {{ __('Users') }}
                </x-navlist.item>
                <x-navlist.item before="phosphor-user" :href="route('roles.index')"
                    :current="request()->routeIs('roles.index')">
                    {{ __('Roles') }}
                </x-navlist.item>
                <x-navlist.item before="phosphor-user" :href="route('permissions.index')"
                ...
                @else
                <x-navlist.item before="phosphor-user" :href="route('reports.index')"
        ...
        <x-navlist>
            <x-navlist.item before="phosphor-git-pull-request" href="https://github.com/imacrayon/blade-starter-kit"
                target="_blank">
                {{ __('Repository') }}
            </x-navlist.item>

            <x-navlist.item before="phosphor-book-open-text" href="https://laravel.com/docs/starter-kits"
                target="_blank">
                {{ __('Documentation') }}
            </x-navlist.item>
        </x-navlist>
